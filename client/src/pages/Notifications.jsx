...
const Notifications = () => {
  ...
  const markAllRead = async () => { await api.patch("/notifications/read-all"); setNotifications((items) => items.map((item) => ({ ...item, isRead: true }))); showToast("All notifications marked as read."); };
